...
|----------|-----|----------|
| English | [HTML](./DQuant_Research/en/) | [DQuant_Research.md](../DQuant_Research.md) |
| Russian | [HTML](./DQuant_Research/ru/) | [DQuant_Research_ru.md](../DQuant_Research_ru.md) |

Research code: [github.com/artrdon/DQuant_Research](https://github.com/artrdon/DQuant_Research)
...
- DQuant channel: [@DQuant_Official](https://t.me/DQuant_Official)
...
- [DQuant main site](https://dquant.space/)
- [Python library](https://dquant.space/library/)
- [DQuant on GitHub](https://github.com/artrdon/dquant)

---

## License

Research materials follow the licensing stated in each publication. The DQuant library is distributed under the [MIT License](https://github.com/artrdon/dquant/blob/main/LICENSE).
